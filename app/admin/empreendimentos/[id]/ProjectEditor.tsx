...
export function ProjectEditor({ project }: { project: any }) {
  ...
  async function save(event: FormEvent) {
    ...
    const payload = {
      ...
      areaFrom: form.areaFrom || null,
      areaTo: form.areaTo || null,
      ...
      <div className="editor-grid">
        ...
        <label>
          ...
          <input
            type="number"
            value={form.priceTo ?? ''}
            onChange={(e) => set('priceTo', e.target.value ? Number(e.target.value) : null)}
          />
        </label>
        <label>
          Área inicial
          <input
            type="number"
            value={form.areaFrom ?? ''}
            onChange={(e) => set('areaFrom', e.target.value ? Number(e.target.value) : null)}
          />
        </label>
        <label>
          Área final
          <input
            type="number"
            value={form.areaTo ?? ''}
            onChange={(e) => set('areaTo', e.target.value ? Number(e.target.value) : null)}
          />
        </label>
