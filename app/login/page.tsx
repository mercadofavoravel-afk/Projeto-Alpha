...
export default async function LoginPage({ searchParams }: { searchParams: Promise<{ error?: string; reset?: string }> }) {
  ...
  const message = query.error === "RATE_LIMITED"
    ...
    : query.error
      ...
      : query.reset
        ...
        : null;
  return <main className="login-shell"><form className="login-card" action={loginAction}>
    <div className="eyebrow">Área restrita</div><h1>ALPHA Admin</h1><p>Entre com uma conta autorizada.</p>
