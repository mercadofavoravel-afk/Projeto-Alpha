# Mapa inicial de destinos editoriais — Projeto Alpha

Atualizado em 25/09/2026. Esta lista separa páginas públicas registradas como
`PUBLISHED` no banco do Alpha de páginas próprias identificadas no site principal.
Antes de inserir um link em novo artigo, conferir a resposta da URL, o produto e a
disponibilidade. Conferir também artigos já publicados no WordPress para evitar
concorrência entre textos sobre a mesma intenção de busca.
...
uma segunda página com tema equivalente.

## Produtos e áreas na fila de verificação

- Centro do Rio e Porto Maravilha: mapear lançamentos de studios e páginas próprias.
- Cidade Arte (Calper), Gaia Rio e Pininfarina: conferir grafia, material do
  produto, vínculo com o catálogo e URL própria antes de citar ou linkar.
- Outros projetos da Barra e do Recreio: completar o inventário das páginas
  WordPress e atualizar o catálogo Alpha. Praia do Pepê é uma referência da Barra.

## Regra de produção

Variar bairro, dor do cliente, tipo de imóvel e empreendimento em cada ciclo.
Pesquisar preço por m², valorização, comércio, restaurantes, praia, mobilidade e
pontos de interesse conforme o tema; números exigem fonte, data e método.
Rascunhos ficam como `DRAFT`. Publicação exige comando posterior do usuário.
Todo link comercial aponta para página própria comprovada, nunca para construtora.
