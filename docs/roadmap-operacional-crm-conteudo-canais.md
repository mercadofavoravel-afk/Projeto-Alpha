...
| ------------ | --------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| Entrada      | Formulários de artigo e empreendimento gravam lead com consentimento e origem; tarefa imediata e sequência sugerida de follow-up são criadas. | Conferir no Neon e em produção com contatos reais autorizados; adicionar deduplicação e integração com leads de portais/redes.                               |
...
| Atendimento  | Status, ficha, atividades, agenda e quadro comercial existem; o novo lead gera uma tarefa imediata de primeiro atendimento.                   | Regra configurável de prazo, notificações, alerta de lead parado e vínculo explícito com visita/proposta.                                                    |
