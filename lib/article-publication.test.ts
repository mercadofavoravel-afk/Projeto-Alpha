...
describe('article publication checklist', () => {
  const completeArticle = {
    ...
    content: 'Conteúdo original e revisado para orientar o leitor com informações úteis sobre o mercado imobiliário.',
    excerpt: 'Guia para investidores e compradores de alto padrão no Rio de Janeiro.',
    seoDescription: 'Entenda os critérios para avaliar oportunidades imobiliárias no Rio de Janeiro.',
